...
class User implements UserInterface
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Creneau::class, mappedBy="idUser")
     */
    private $creneaus;

    /**
     * @ORM\OneToMany(targetEntity=Message::class, mappedBy="idVendeur")
     */
    private $messages;
    ...
    public function removeCreneau(Creneau $creneau): self
    {
        if ($this->creneaus->removeElement($creneau)) {
            // set the owning side to null (unless already changed)
            if ($creneau->getIdUser() === $this) {
                $creneau->setIdUser(null);
            }
        }
    ...
    public function removeMessage(Message $message): self
    {
        if ($this->messages->removeElement($message)) {
            // set the owning side to null (unless already changed)
            if ($message->getIdVendeur() === $this) {
                $message->setIdVendeur(null);
            }
        }
